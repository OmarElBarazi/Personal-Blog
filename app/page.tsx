    ...
    <div className="container mx-auto px-5">
      <main>
        <div className="space-y-4">
          <h1 className="text-center text-3xl font-bold">Omar El Bakir El Barazi Blog</h1>
          <p className="text-center text-xl">
            Welcome to my blog where I share some of my remarkable experiences throughout my life.
          </p>
        </div>
